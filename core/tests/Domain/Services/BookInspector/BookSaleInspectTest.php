...
class BookSaleInspectTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->inspector = new BookSaleInspect($this->repoBorrowLine);
    }
    ...
    public function testShouldFalseWhenTheStockIsNotEnough(): void
    {
        $book = BookMother::romeoAndJuliet();
        $book->changeStock(2);
    ...
    public function testShouldFalseWhenTheStockIsNotEnoughWithHasBorrows(): void
    {
        $this->repoBorrowLine->attach(Ref::BorrowLineJohnQuijote);
